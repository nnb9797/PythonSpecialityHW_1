...
# атрибуты в init Rectangle в являются объектами класса Validator
# и при инициализации проверяются на диапазон в классе Validator
...
class Rectangle:
    ...
    def __init__(self, width: float, length: float = None) -> None:
        """Атрибуты в init Rectangle в являются объектами класса Validator и при инициализации проверяются на
        диапазон в классе Validator """
        self.width = width
    ...
    def get_area(self) -> float:
        """Вызов property c length и возврат _length."""
